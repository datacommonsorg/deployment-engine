...
class Config(_base.Config):
  ...
  OVERRIDE_CSS_PATH = '/custom_dc/energy/overrides.css'
  LOGO_PATH = "/custom_dc/energy/logo.png"
  TEMPLATES_BASE_LOCATION = "custom_dc/energy/admin"
  ...
  CSV_SCHEMAS = {
      'leases_example_data.csv': {
          "entity": STRING,
          "variable": STRING,
          "date": DATE_YEAR,
          "value": NUMBER,
      },
      'asset_locations_example_data.csv': {
          "entity": STRING,
          "variable": STRING,
          "date": DATE_YEAR,
          "value": NUMBER,
